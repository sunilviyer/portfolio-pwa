// File: src/components/navigation/SideMenu.js
      ...
      <div className={`fixed left-0 top-0 h-full w-80 bg-white shadow-lg transform transition-transform duration-300 z-50 ${
        ...
        <div className="p-4">
          ...
          <button
            ...
            className="w-full mt-6 flex items-center p-3 rounded-lg text-left bg-red-50 text-red-700 border border-red-200 hover:bg-red-100 transition-colors"
          >
            <RefreshCw size={20} className="mr-3" />
            <div>
              <div className="font-medium">Reset Data</div>
              <div className="text-xs text-red-500">Restore original portfolio and cash</div>
            </div>
          </button>
        </div>
      </div>
